...
<div class="container" style=" width: 80%;
    ...
    <div class="details" style="margin-bottom: 20px;">
        <p><strong>Admin_Username:</strong> <%= request.getAttribute("username") %></p>
    ...
    <form action="AllCustomers">
        <button type="submit">View All Customers</button>
    </form>
    <form action="admin_register.jsp">
        <button type="submit">Add Admins to System</button>
    </form>
