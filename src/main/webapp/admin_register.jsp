...
<div class="container mt-5" style=" width: 80%;
    ...
    <form action="AdminRegisterServlet" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="confirmationCode" name="confirmationCode" required style="width: 100%">
        </div>
        <button type="submit" class="btn" style="background: linear-gradient(90deg, #ff416c, #ff4b2b); color: white; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer; transition: background-color 0.3s ease;">Register</button>
    </form>
</div>
<div style=" text-align: center;
    margin: 40px;">
<button id="login" style="background: linear-gradient(90deg, #ff416c, #ff4b2b); color: white; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer; transition: background-color 0.3s ease;" onclick="window.location.href='login.jsp'">Login</button>
</div>
