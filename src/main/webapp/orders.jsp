...
<%@ page import="lk.ijse.ecommerce_web_application.Dto.Order" %><%--
...
<h1 style="margin-top: 5vw">Your Orders</h1>
...
<table border="1">
  ...
  <tr onclick="viewOrderDetails(<%= order.getOrderId() %>)">
...
<script>
  function viewOrderDetails(orderId) {
    window.location.href = "OrderDetailsServlet?orderId=" + encodeURIComponent(orderId);
  }
</script>
</body>
</html>
